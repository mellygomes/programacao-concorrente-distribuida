...
def sierpinski():
    ...
    with Lock:
        ...
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "sierpinski.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def samambaia_barnsley():
    ...
    with Lock:
        ...
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "samambaia_barnsley.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def mandelbrot(width=800, height=800, max_iter=100):
    ...
    with Lock:
        ...
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "mandelbrot.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def julia(c=-0.7 + 0.27015j, width=800, height=800, max_iter=100):
    ...
    with Lock:
        ...
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "julia.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def koch_curve(order=4, size=300):
    ...
    with Lock:
        ...
        plt.axis('equal')
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "koch_curve.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def fractal_tree():
    ...
    with Lock:
        ...
        plt.axis('equal')
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "fractal_tree.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def sierpinski_carpet(size=3, iterations=4):
    ...
    with Lock:
        ...
        plt.axis('off')
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "sierpinski_carpet.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def menger_sponge(iterations=2):
    ...
    with Lock:
        ...
        plt.savefig(os.path.join(os.path.expanduser("~"), "OneDrive\Área de Trabalho", "menger_sponge.png"), bbox_inches='tight', dpi=300)
        plt.close()
...
def gerar_todos_fractais():
    ...
    t1 = th.Thread(target = lambda: sierpinski())
    Threads.append(t1)

    t2 = th.Thread(target = lambda: samambaia_barnsley())
    Threads.append(t2)

    t3 = th.Thread(target = lambda: mandelbrot())
    Threads.append(t3)

    t4 = th.Thread(target = lambda: julia())
    Threads.append(t4)

    t5 = th.Thread(target = lambda: koch_curve())
    Threads.append(t5)

    t6 = th.Thread(target = lambda: fractal_tree())
    Threads.append(t6)

    t7 = th.Thread(target = lambda: sierpinski_carpet())
    Threads.append(t7)

    t8 = th.Thread(target = lambda: menger_sponge())
    Threads.append(t8)
...
if __name__ == "__main__":
    ...
    t1 = time()
    print(f"\nA execução paralela levou {t1 - t0:.5f} segundos.\n")