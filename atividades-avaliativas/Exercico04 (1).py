import matplotlib  
matplotlib.use('Agg') # Para que a matplotlib não utilize o GUI (que não funciona com threads)
...
if __name__ == "__main__":
    ...
    fim = time()
    t1 = fim - inicio
    print(f"Tempo de execução com threads: {t1:.4f} segundos\n")
    ...
    fim = time()
    t2 = fim - inicio
    print(f"Tempo de execução sem threads: {t2:.4f} segundos\n")

    print("Resultado do teste: ")
    if t1 < t2:
        print(f"A execução paralela foi {(t2 - t1):.4f} segundos mais rápida.\n")
    else:
        print(f"A execução sequencial foi {(t1 - t2):.4f} segundos mais rápida.\n")